About rake_nltk-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/rake_nltk-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3495&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rake_nltk-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rake_nltk` can be installed with `conda`:
...
```
mamba install rake_nltk
```

It is possible to list all of the versions of `rake_nltk` available on your platform with `conda`:
...
```
mamba search rake_nltk --channel conda-forge
```
...
mamba repoquery search rake_nltk --channel conda-forge

# List packages depending on `rake_nltk`:
mamba repoquery whoneeds rake_nltk --channel conda-forge

# List dependencies of `rake_nltk`:
mamba repoquery depends rake_nltk --channel conda-forge
```
